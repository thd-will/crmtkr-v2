...
<body class="bg-gray-50">
    <div class="min-h-screen py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-lg shadow-md p-6 mb-6">
                <h3 class="text-lg font-medium text-gray-900 mb-4">รายละเอียดกรมธรรม์และบันทึกถึงเจ้าหน้าที่ทิพยประกันภัย</h3>
                
                <!-- Policy Basic Info -->
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-6">
                    @if($ticket->insurance_type)
                    <div>
                        <span class="text-sm text-gray-600">ประเภทประกัน:</span>
                        <span class="font-medium text-gray-900 ml-2">
                            {{ $ticket->insurance_type == 'MOU' ? 'MOU' : 'มติ 24' }}
                        </span>
                    </div>
                    @endif
                    ...
                    @if($ticket->duration)
                    <div>
                        <span class="text-sm text-gray-600">ระยะเวลาความคุ้มครอง:</span>
                        <span class="font-medium text-gray-900 ml-2">
                            @switch($ticket->duration)
                                @case('3_months') 3 เดือน @break
                                @case('6_months') 6 เดือน @break
                                @case('12_months') 12 เดือน @break
                                @case('15_months') 15 เดือน @break
                    ...
                    <div>
                        <span class="text-sm text-gray-600">จำนวนคน:</span>
                        <span class="font-medium text-gray-900 ml-2">{{ number_format($ticket->person_count) }} คน</span>
                    </div>
                    @endif
                    
                    @if($ticket->priority)
                    <div>
                        <span class="text-sm text-gray-600">ความสำคัญ:</span>
                        <span class="font-medium ml-2
                            ...
                            @switch($ticket->priority)
                                @case('urgent') ด่วนมาก @break
                                @case('high') สูง @break
                                @case('normal') ปานกลาง @break
                                @case('low') ต่ำ @break
                    ...
                    @if($ticket->due_date)
                    <div>
                        <span class="text-sm text-gray-600">กำหนดเสร็จ:</span>
                ...
                <div class="border-t pt-4">
                    <div class="mb-4">
                        <label class="block text-sm font-medium text-gray-700 mb-2">บันทึกถึงเจ้าหน้าที่ทิพยประกันภัย:</label>
                ...
                <div class="border-t pt-4 mt-4">
                    <h4 class="text-md font-medium text-gray-900 mb-3">📎 ไฟล์จากลูกค้า</h4>
                    <div class="bg-green-50 border border-green-200 rounded-lg p-3">
                        <div class="flex items-center">
                            ...
                            <span class="text-sm text-green-800">ไฟล์แนบจากลูกค้า:</span>
